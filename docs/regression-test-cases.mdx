...
**Title:** Verify searching for a specific task filters results accurately  
**Priority:** High  
**Type:** Functional, Positive, Regression  
...
**Title:** Verify clearing the search term restores full task list  
**Priority:** High  
**Type:** Functional, Positive, Regression  
**Functionality Area:** Search
...
**Title:** Verify that searching for a non-existent task shows empty state  
**Priority:** Medium  
